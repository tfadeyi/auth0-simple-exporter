...
func NewUserOperationsMetric(namespace, subsystem string) *prometheus.CounterVec {
...
func UserOperationsEventHandler(ctx context.Context, log *management.Log) error {
	if ctx == nil {
